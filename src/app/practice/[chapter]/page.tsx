...
//     Record<number, "correct" | "wrong" | "skipped">
//   >({});
//   const [attempted, setAttempted] = useState(0);
//   const [correct, setCorrect] = useState(0);
//   const [wrong, setWrong] = useState(0);
...
//       {/* Top controls with Circle in left side */}
//       <div className="flex mb-6">
//         {/* Big circle showing progress - positioned at left */}
...
//         {/* Summary and reset buttons - right aligned */}
...
//       {/* Question content - KEEPING ORIGINAL LAYOUT */}
//       <div ref={questionRef} className="mb-4">
//         <div className="font-semibold mb-4 text-base sm:text-lg flex items-start">
//           <div className="flex-grow">
//             <span>
...
//                 onClick={() => handleOptionClick(key)}
//                 className={classNames(
//                   "w-full text-left px-3 sm:px-4 py-2 sm:py-3 rounded-lg border transition duration-200 shadow-sm text-sm sm:text-base pr-10",
//                   {
//                     "bg-green-100 border-green-600 text-green-800":
//                       showAnswer && key === q.correct_option,
//                     "bg-red-100 border-red-600 text-red-800":
...
//       {/* Summary slide-in panel from right */}
//       {showSummary && (
//         <div className="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out overflow-y-auto">
//           <div className="p-4">
//             <div className="flex justify-between items-center mb-4 border-b pb-2">
//               <h3 className="font-bold text-lg">Progress Summary</h3>
//               <button
//                 onClick={toggleSummary}
...
//                     {Object.keys(progress).length}/{questions.length}
//                   </p>
//                 </div>
//                 {/* Progress bar */}
...
//                 <p className="text-sm text-gray-600">Accuracy</p>
//                 <div className="flex justify-between">
//                   <p className="font-semibold">{getAccuracyPercentage()}%</p>
//                   <p className="text-sm text-gray-600">
//                     {correct}/{attempted}
//                   </p>
//                 </div>
...
//               <button
//                 onClick={resetProgress}
//                 className="w-full px-4 py-2 bg-red-100 hover:bg-red-200 rounded text-sm font-medium mt-4"
//               >
//                 Reset All Progress
//               </button>
//             </div>
...
//       {/* Dark overlay when summary is shown */}
//       {showSummary && (
//         <div
