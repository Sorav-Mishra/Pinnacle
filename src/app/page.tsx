      ...
      <footer className="bg-gray-800 dark:bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-bold">SSC Exam Prep</h3>
              </div>
              <p className="text-gray-300">
                Your comprehensive platform for SSC exam preparation with real
                questions, expert guidance, and targeted practice.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  { name: "Practice Tests", path: "/ssc-pyq" },
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
            <p>
              © {new Date().getFullYear()} SSC Exam Prep. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
